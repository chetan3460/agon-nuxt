...
import { _ as _sfc_main$a } from './NuxtImg-B3Loof8F.mjs';
...
import { _ as _sfc_main$9 } from './BlogItem-F5gUUBuI.mjs';
import { u as useDynamicComponents } from './useDynamicComponents-x-gTFNM7.mjs';
import 'unhead';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (bannerBlock.value !== null) {
        ...
        _push(`</div></div><div class="hidden relative flex-1 h-auto self-stretch lg:block"><div class="absolute w-full left-20 animate-hero-thumb-sm-animation bottom-[-60px] max-w-[526px]"><img${ssrRenderAttr("src", `${unref(strapiBaseUrl)}${bannerBlock.value.bannerImage.url}`)} class="h-full w-full object-cover" alt="image"></div><div class="absolute opacity-80 animate-float max-w-[176px] bottom-[10%] -translate-x-1/3"><div class="relative bg-green-900 bg-opacity-80 rounded-2xl grid place-items-center"><img class="h-full w-full object-cover"${ssrRenderAttr("src", `${unref(strapiBaseUrl)}${(_a = bannerBlock.value.videoImg) == null ? void 0 : _a.url}`)} alt="Agon"><p class="text-heading-4 absolute text-white font-chivo font-bold ml-[49px]">Watch intro video </p><button class="rounded-full bg-white grid place-items-center absolute play-video w-[64px] h-[64px] left-[-15%]"><img${ssrRenderAttr("src", _imports_0$3)} alt="play button" width="15"></button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (seeWhyData.value !== null) {
        ...
        ssrRenderList(seeWhyData.value.SeeWhyBlockItems, (item, index) => {
          var _a2;
          _push(`<div class="${ssrRenderClass(["tab-content lg:gap-[30px] lg:flex", selectedTab.value === index ? index === 0 ? "bg-bg-2" : "bg-bg-3" : "!hidden"])}"><div class="p-5 md:p-[60px] lg:w-1/2"><div class="prose prose-h2:font-bold prose-h2:font-chivo prose-h2:text-[28px] prose-h2:leading-[32px] prose-h2:mb-[30px] prose-p:text-excerpt prose-p:text-[20px] prose-p:mb-[40px] mb-[60px]">${(_a2 = renderMarkdown(item.description)) != null ? _a2 : ""}</div><button type="button">`);
          _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=index-Vk6jzkfB.mjs.map
