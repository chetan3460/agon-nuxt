...
const _sfc_main = {
  ...
  setup(__props) {
    const resolveComponent = (componentName) => {
      const componentMap = {
        "page-blocks.hero-about-block": defineAsyncComponent(() => import('./HeroAboutBlock-BuhMOZny.mjs')),
        ...
        "page-blocks.service-page-banner-block": defineAsyncComponent(() => import('./ServicePageBannerBlock-Bm5pGaoS.mjs')),
        "page-blocks.partner-block": defineAsyncComponent(() => import('./PartnerBlock-qkPkD9mG.mjs')),
        "page-blocks.card-block-layout-two": defineAsyncComponent(() => import('./CardBlockLayoutTwo-DHJ2DYFh.mjs')),
...
//# sourceMappingURL=slugbackup-BRy8lXtt.mjs.map
